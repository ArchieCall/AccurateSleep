function demo()
  ...
  ====================================================================
  regulate(num_samples::Int = 5000, update::Bool = false)
  ====================================================================
  ...
  .. if update = true, store the returned value
  '''
  =#
  ...
  for q = 1:1
    ...
    AccurateSleep.simulate(.000001, 10000)
    return
    suggested_default = AccurateSleep.regulate(1000)     #--- evaluate potential default_threshold values
    @printf("suggested_default => %9.4f\n", suggested_default)
    AccurateSleep.simulate(.05, 200, suggested_default)
